//Copyright (c) 2021 Xiaosheng Li (xli22@gmu.edu)
//Reference: Time Series Clustering in Linear Time Complexity, DMKD 2021
/*
...
int main(int argc, char *argv[]) {
	...
	//string path = "./UCRArchive_2018_processed/";
	//string path2 = "./UCRArchive_2018_processed/";
	string path = "./";
	string path2 = "./";
